    ...
    <div className="min-h-screen  bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          {/* Header */}
          <div className="">
            <h1 className="text-4xl md:text-6xl font-bungee mb-6">Saved Links</h1>
            <p className="text-xl text-gray-300 mb-8">
              Explore my Research, Links, and technical Resources from years of working in web and mobile
              development.
            </p>
          ...
          <div className="flex mb-6 items-center space-x-4">
            ...
            <div className="flex bg-white rounded-lg p-1">
              <button
                ...
                className={`px-3 py-1 rounded-md text-sm font-medium ${viewMode === "grid" ? "text-black  shadow-sm" : "text-gray-600"
                  }`}
              >
                Grid
              </button>
              <button
                ...
                className={`px-3 py-1 rounded-md text-sm font-medium ${viewMode === "list" ? "text-black shadow-sm" : "text-gray-600"
                  }`}
              >
                List
              </button>
