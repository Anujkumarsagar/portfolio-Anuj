...
const projects = [
  {
    ...
    description:
      "A multi-page multi functional Application where Top Notch Recipes can be listed.",
    cardData: [
      {
        color: "#060010",
  ...
  {
    id: 1,
    title: "Dost Saas Webapp",
    description:
      "A modern auto generate transcription of live video , user can share public link to see the recorded video with transcriptions.",
    cardData: [
      {
        color: "#060010",
        label: "Dost Saas Webapp",
        image: "./assets/home/logo.png",
        title: "Dost Saas Webapp",
        description: "",
      },
      ...
      {projects.map((project, idx) => (
        <div key={project.id} id={project.id} className="border squircle-a-20 py-4">
          {enableSpotlight && (
            <GlobalSpotlight
              gridRef={(element) => {
                gridRefs.current[project.id] = element;
              }}
          ...
          <BentoCardGrid gridRef={(element) => {
                gridRefs.current[project.id] = element;
              }} >
            {project.cardData.map((card, index) => {
              const baseClassName = `magic-bento-card rounded-2xl bg-red-500 ${
                ...
                return (
                  ...
                  >
                    ...
                    <img
                      src={card?.image}
                      alt={card.title}
                      className="h-[60%] object-cover squircle-a-20 border-2 "
                    />
